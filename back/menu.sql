...
(97, 'Papas', 'otro', '', NULL, 0, '2026-02-01 23:47:31'),
(98, 'Pimienta', 'otro', '', NULL, 0, '2026-02-01 23:47:32');
...
(0, 1, 2, 2000, '2026-02-28', '2026-02-24 19:08:57'),
(0, 1, 85, 2000, '2026-02-28', '2026-02-24 19:09:35');
...
(4, 'Sándwich Mixto', 'Cena ligera o merienda rápida.', '1. Tomar dos rebanadas de pan. 2. Colocar jamón y queso. 3. Calentar en sartén o tostadora hasta que el queso derrita.', 'easy', 5, 1, 'https://img.freepik.com/vector-gratis/ingredientes-sandwich-icono-vectorial-dibujos-animados-ilustracion-alimentos-icono-objeto-icono-plano-aislado_138676-11218.jpg?semt=ais_hybrid&w=740&q=80', 250, 1, 1, '2026-02-01 22:17:00'),
...
(47, 'prueba', 'prueba', 'paso1\npaso2', 'regular', 30, 2, '', 400, 1, 1, '2026-02-24 19:38:49'),
(48, 'laas', 'asda', 'asd\nasda', 'regular', 40, 2, '', 540, 1, 1, '2026-02-24 19:39:26');
...
--
ALTER TABLE `daily_meals`
  MODIFY `daily_meal_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `ingredients`
  MODIFY `ingredient_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=99;

--
-- AUTO_INCREMENT de la tabla `menu_plans`
--
ALTER TABLE `menu_plans`
  MODIFY `menu_plan_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
